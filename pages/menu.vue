...
<template>
    <div>
        <section>
            <v-parallax v-bind:src="require('@/assets/images/menu.jpg')" height="650" class="hero-1">
                <v-layout
                        column
                        align-center
                        justify-center
                ...
                >
                    ...
                    <div class="subheading mb-3 text-xs-center"
                         style="text-shadow: 2px 2px #111; font-size: 140% !important;">A great choice for everybody.
                    </div>
                </v-layout>
            </v-parallax>
        </section>
        <section>
            <v-flex xs12 sm8 offset-sm2>
                <v-card>
                    <v-card-text>
                        <h2>Eat</h2>
                        <p>The Miners Standard has an large array of food to suit every taste whether you are vegan,
            ...
            <v-flex xs12 sm8 offset-sm2>
                <v-card>
                    <v-card-text>
                        ...
                        <p>Some of our Ales are locally sourced and loved by all.</p>
                    </v-card-text>
                </v-card>
            </v-flex>
        </section>
