...
<template>
    <div>
        <section>
            <v-parallax src="/images/hero1.jpg" height="650" class="hero-1">
                <v-layout
                        column
                        align-center
                        justify-center
                ...
                >
                    ...
                    <div class="subheading mb-3 text-xs-center" style="text-shadow: 2px 2px #111; font-size: 140% !important;">A good old fashioned British Pub</div>
                </v-layout>
            </v-parallax>
        </section>
